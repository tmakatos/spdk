...
$SPDK_EXAMPLE_DIR/identify -r 'trtype:CUSTOM traddr:/var/run/muser/domain/muser0/8' -g -L nvme -L nvme_vfio -L vfio_pci
sleep 1
...
sleep 1
$SPDK_EXAMPLE_DIR/reconnect -r 'trtype:CUSTOM traddr:/var/run/muser/domain/muser0/8' -g -q 32 -o 4096 -w randrw -M 50 -t 10 -c 0xE
sleep 1
